 ...
 * @since 2023-10-31
 */
@ApiModel(value = "VizMcMachineAssignTaskEoPageParam分页查询参数对象", description = "【可视化】机器分配任务表")

public class VizMcMachineAssignTaskEoPageParam extends PageSet implements Serializable{
    ...
    @NotNull(groups = ValidationGroups.Insert.class,message = "app许可证id不能为null")
    private Long appLicenseId;


    @ApiModelProperty("app许可证类型（1：云应用，2：云手机，3：云游戏）")
    @NotNull(groups = ValidationGroups.Insert.class,message = "app许可证类型（1：云应用，2：云手机，3：云游戏）不能为null")
