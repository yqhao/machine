...
public class TencentDeviceAccessInfoParam implements Serializable {
    ...
    public String toString() {
        return "TencentDeviceAccessInfo{" + "id=" + id + ", fkTencentDeviceId=" + fkTencentDeviceId + ", instanceId=" + instanceId + ", serverIp=" + serverIp + ", serverPort=" + serverPort + ", publicIp=" + publicIp + ", publicPort=" + publicPort + ", isp=" + isp + ", createTime=" + createTime + ", lastUpdateTime=" + lastUpdateTime + "}";
    }
}
