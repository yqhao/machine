...
public class YunMemberDeviceParam implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty("id")
    @NotNull(groups = ValidationGroups.Update.class,message = "id id不能为null")
    private Long id;
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date queryEndFreezeStartTime;
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date queryEndFreezeEndTime;
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date queryEndLastRenewTime;
     ...
     * 使用有效期开始时间
     */
    public Date getQueryEndValidStartTime() {
        return queryEndValidStartTime;
    }

    /**
     * 使用有效期开始时间
     */
    public void setQueryEndValidStartTime(Date queryEndValidStartTime) {
        this.queryEndValidStartTime = queryEndValidStartTime;
    }
    /**
     * 使用有效期结束时间
     */
     ...
     * 使用有效期结束时间
     */
    public Date getQueryEndValidEndTime() {
        return queryEndValidEndTime;
    }

    /**
     * 使用有效期结束时间
     */
    public void setQueryEndValidEndTime(Date queryEndValidEndTime) {
        this.queryEndValidEndTime = queryEndValidEndTime;
    }
    /**
     * 冻结开始时间
     */
     ...
     * 冻结开始时间
     */
    public Date getQueryEndFreezeStartTime() {
        return queryEndFreezeStartTime;
    }

    /**
     * 冻结开始时间
     */
    public void setQueryEndFreezeStartTime(Date queryEndFreezeStartTime) {
        this.queryEndFreezeStartTime = queryEndFreezeStartTime;
    }
    /**
     * 冻结结束时间（释放设备的时间）
     */
     ...
     * 冻结结束时间（释放设备的时间）
     */
    public Date getQueryEndFreezeEndTime() {
        return queryEndFreezeEndTime;
    }

    /**
     * 冻结结束时间（释放设备的时间）
     */
    public void setQueryEndFreezeEndTime(Date queryEndFreezeEndTime) {
        this.queryEndFreezeEndTime = queryEndFreezeEndTime;
    }
    /**
     * 总天数（单位：天）
     */
     ...
     * 订购时间
     */
    public Date getQueryEndBuyTime() {
        return queryEndBuyTime;
    }

    /**
     * 订购时间
     */
    public void setQueryEndBuyTime(Date queryEndBuyTime) {
        this.queryEndBuyTime = queryEndBuyTime;
    }
    /**
     * 最近一次续费时间
     */
     ...
     * 最近一次续费时间
     */
    public Date getQueryEndLastRenewTime() {
        return queryEndLastRenewTime;
    }

    /**
     * 最近一次续费时间
     */
    public void setQueryEndLastRenewTime(Date queryEndLastRenewTime) {
        this.queryEndLastRenewTime = queryEndLastRenewTime;
    }
    /**
     * 创建时间
     */
     ...
     * 设备空闲上报时间
     */
    public Date getQueryEndIdleTime() {
        return queryEndIdleTime;
    }

    /**
     * 设备空闲上报时间
     */
    public void setQueryEndIdleTime(Date queryEndIdleTime) {
        this.queryEndIdleTime = queryEndIdleTime;
    }
    /**
     * 
     */
