...
import com.suqi.center.machine.dao.mapper.BaiduImagesMapper;
...
@Service
@Primary
public class BaiduImagesServiceImpl extends ServiceImpl<BaiduImagesMapper, BaiduImages> implements IBaiduImagesService {

    @Override
    public Page<BaiduImages> quickPageById(boolean queryTotals, Page<BaiduImages> page, long lastId, QueryWrapper<BaiduImages> wrapper) {
    ...
    @Override
    public Page<BaiduImages> quickPage(Page<BaiduImages> page, QueryWrapper<BaiduImages> wrapper) {
        long total = 0L;
        boolean overrideSelect = false;
        String sqlSelect = wrapper.getSqlSelect();
        if (sqlSelect != null && !"".equals(sqlSelect) && sqlSelect.indexOf(",") > 0) {
